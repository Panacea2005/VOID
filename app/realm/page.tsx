...
const realms = [
  ...
  },
  {
    id: "cryptic",
    name: "CRYPTIC",
    poem: "Geometric precision,\nFalling shapes align,\nOrder emerging from chaos,\nPerfection in design.",
    theme: "Spatial and Pattern",
    description:
      "A realm of falling block puzzles where shapes must be arranged in perfect harmony. Players navigate spatial dimensions to clear lines and restore order from chaos, with each successful arrangement revealing fragments of the digital universe's structure.",
  ...
  },
  {
    ...
    description:
      "A mysterious realm at the edge of perception. Strange geometries and fractal patterns suggest access to dimensions beyond conventional understanding. Players experience reality-bending challenges where the laws of physics seem malleable and time flows differently.",

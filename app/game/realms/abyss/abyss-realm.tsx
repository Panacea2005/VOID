        ...
        {food && (
          ...
          >
            <div className="w-full h-full flex items-center justify-center">
              <div
                className="w-1/2 h-1/2 relative rounded-full bg-purple-500"
  ...
  const renderIntroScreen = () => (
    <div className="flex flex-col items-center justify-center h-full text-center">
      ...
      <div className="text-gradient-animation mb-10">
        <div className="text-3xl font-light text-blue-300 font-pixel">
          Level {level}
        </div>
      </div>
      ...
      <p className="text-gray-300 max-w-md mb-10 text-xl leading-relaxed">
        Navigate the void, collect light fragments, and find the portal to the
        next level.
      </p>
      ...
      <div className="flex gap-4">
        <button
          onClick={startGame}
          className="px-10 py-4 text-xl bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-500 hover:to-purple-500 text-white rounded-md font-pixel transition-transform hover:scale-105 active:scale-95"
        >
          Enter the Void
        </button>
  ...
  const renderGameOverScreen = () => (
    <div className="absolute inset-0 bg-black/90 flex flex-col items-center justify-center z-50">
      ...
      <p className="text-gray-300 mb-8 text-xl">
        Your cube has been lost to the void...
      </p>
      ...
      >
        ...
        <div className="text-green-300 text-sm">
          {portalVisible
            ...
            : `Need ${Math.max(
                0,
                requiredLengthForPortal - snake.length
              )} more to open portal`}
        </div>
      </div>

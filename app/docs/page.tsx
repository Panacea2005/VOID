...
const FeatureShowcase: React.FC<FeatureShowcaseProps> = ({ title, description, features, color, index }) => {
  const colorClasses = {
    purple: {
      bg: "bg-purple-500/20",
      text: "text-purple-500",
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10">
        <h3 className={`text-xl font-bold mb-4 text-transparent bg-clip-text bg-gradient-to-r ${colorClass.gradient}`}>
          {title}
        </h3>
...
export default function DocsPage() {
  ...
  const docSections: Array<{
    ...
    {
      title: "GAME",
      description: "Explore the various games available in the VOID ecosystem, from immersive VR experiences to browser-based adventures.",
      icon: "grid",
      color: "purple",
    },
    {
      title: "AI",
      description: "Learn about the AI systems that power asset generation, gameplay adaptation, and personalized experiences.",
      icon: "dots",
      color: "pink",
    },
    {
      title: "GALLERY",
      description: "View and share creations in our community gallery, featuring the best artwork and assets from the VOID.",
      icon: "wave",
      color: "blue",
    },
    {
      title: "REALM",
      description: "Understand the interconnected world of VOID, where multiple games share a common universe and economy.",
      icon: "grid",
      color: "purple",
    },
    {
      title: "ART",
      description: "Discover the tools and techniques for creating unique digital art that can be minted as NFTs within our ecosystem.",
      icon: "dots",
      color: "pink",
    },
    {
      title: "MARKET",
      description: "Navigate the NFT marketplace where you can buy, sell, and trade your digital assets across different games.",
      icon: "wave",
      color: "blue",
    },
    {
      title: "RUBIKS",
      description: "Discover our library for exploring the features and structural patterns of a Rubik's Cube, including visualization tools and pattern analysis.",
      icon: "square",
      color: "purple",
    },
    {
      title: "CANVAS",
      description: "Join a collaborative digital canvas where users can color pixels to create massive, community-driven pixel art masterpieces.",
      icon: "dots",
      color: "blue",
    }
  ]
  ...
  const featureShowcases = [
    {
      ...
      description: "How assets from the VOID marketplace can be used across multiple game environments:",
      features: [
    ...
    {
      title: "AI GENERATION",
      description: "The AI systems that power content creation in the VOID ecosystem:",
      features: [
    ...
    },
    {
      ...
      description: "The secure blockchain infrastructure that powers digital ownership:",
      features: [
          ...
          <div className="flex-1 min-h-[calc(100vh-80px)]">
            ...
            <div className="border-b border-purple-900/30 px-6 py-12 lg:py-16 relative overflow-hidden">
              ...
              <div className="container mx-auto max-w-4xl relative z-10">
                ...
                >
                  Welcome to the comprehensive documentation for the VOID ecosystem. Here you'll find everything you need to understand and navigate our web3 gaming platform, NFT marketplace, and creative tools.
                </motion.p>
              </div>
            </div>
            ...
            <div className="container mx-auto px-6 py-16">
              ...
              <div className="max-w-4xl mx-auto mb-12">
                ...
                >
                  ...
                  <p className="text-gray-300">
                    The VOID ecosystem consists of several interconnected components that work together to create a seamless web3 gaming experience. Explore each area to learn more about specific features and capabilities.
                  </p>
                </motion.div>
              </div>
              ...
              <div className="max-w-4xl mx-auto mb-16">
                ...
                <div className="flex justify-center gap-6 mt-6 flex-col md:flex-row">
                  {docSections.slice(6).map((section, index) => (
                    <div key={index} className="w-full md:w-1/2 lg:w-[calc(33.333%-1.5rem)]">
                      <DocSection
                        title={section.title}
                        description={section.description}
                        icon={section.icon}
              ...
              {/* Feature diagram */}
              <div className="max-w-4xl mx-auto mb-16 border border-purple-900/30 p-8 bg-black/50 relative overflow-hidden">
                <motion.div
                  initial={{ opacity: 0 }}
                ...
                <div className="relative z-10">
                  ...
                  <div className="aspect-video bg-gray-900/50 flex items-center justify-center border border-purple-900/50">
                    <p className="text-gray-400 text-center">
                      [Interactive ecosystem diagram placeholder]<br />
                      Visualizes connections between Games, Marketplace, AI, and User Assets
                    </p>
                  </div>

                  <div className="mt-6 text-gray-300 text-sm">
                    <p>
                      The diagram above illustrates how the various components of the VOID ecosystem interact. The central NFT marketplace connects to all game environments, while the AI systems power content generation across the platform.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="max-w-4xl mx-auto">
                ...
                >
                  ...
                  <p className="text-gray-300">
                    Explore the core technologies and capabilities that make the VOID platform unique in the web3 gaming space.
                  </p>
                </motion.div>
                ...
                >
                  ...
                  <div className="relative z-10">
                    ...
                    <p className="text-gray-300 mb-6">
                      Ready to dive into the VOID? Follow these steps to begin your journey into our web3 gaming ecosystem:
                    </p>

                    <ol className="space-y-4 text-gray-300">
                      <li className="flex">
                        <span className="text-blue-400 font-bold mr-2">1.</span>
                        <span>Create your VOID account and set up your digital wallet</span>
                      </li>
                      <li className="flex">
                        <span className="text-blue-400 font-bold mr-2">2.</span>
                        <span>Explore the marketplace and acquire your first NFT asset</span>
                      </li>
                      <li className="flex">
                        <span className="text-blue-400 font-bold mr-2">3.</span>
                        <span>Choose a game from our ecosystem and use your assets in-game</span>
                      </li>
                      <li className="flex">
                        <span className="text-blue-400 font-bold mr-2">4.</span>
                        <span>Experiment with our AI tools to create custom content</span>
                      </li>
                    </ol>
                ...
                >
                  ...
                  <p className="text-gray-300 mb-6">
                    Join our vibrant community to get help, share your creations, and collaborate with other VOID users.
                  </p>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    >
                      <div className="flex items-center">
                        <div className="w-10 h-10 bg-purple-900/30 flex items-center justify-center mr-4">
                          <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M4 12H20M4 12C2.89543 12 2 11.1046 2 10V6C2 4.89543 2.89543 4 4 4H20C21.1046 4 22 4.89543 22 6V10C22 11.1046 21.1046 12 20 12M4 12V18C4 19.1046 4.89543 20 6 20H18C19.1046 20 20 19.1046 20 18V12" stroke="#a855f7" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                          </svg>
                        </div>
                        <div>
                          <h4 className="font-bold text-white group-hover:text-purple-400 transition-colors">Developer Forum</h4>
                          <p className="text-gray-400 text-sm">Technical discussions and support</p>
                        </div>
                      </div>
                    </Link>
                    ...
                    >
                      <div className="flex items-center">
                        <div className="w-10 h-10 bg-purple-900/30 flex items-center justify-center mr-4">
                          <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M19 14C19 16.7614 16.7614 19 14 19H10C7.23858 19 5 16.7614 5 14V10C5 7.23858 7.23858 5 10 5H14C16.7614 5 19 7.23858 19 10V14Z" stroke="#a855f7" strokeWidth="2" />
                            <path d="M7 10.5H9.5M9.5 10.5H12M9.5 10.5V8M9.5 10.5V13" stroke="#a855f7" strokeWidth="2" strokeLinecap="round" />
                            <path d="M16 11H14M16 14H14" stroke="#a855f7" strokeWidth="2" strokeLinecap="round" />
                          </svg>
                        </div>
                        <div>
                          <h4 className="font-bold text-white group-hover:text-purple-400 transition-colors">Live Workshops</h4>
                          <p className="text-gray-400 text-sm">Weekly tutorials and demonstrations</p>
                        </div>
                      </div>
                    </Link>
                    ...
                    >
                      <div className="flex items-center">
                        <div className="w-10 h-10 bg-purple-900/30 flex items-center justify-center mr-4">
                          <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M12 2C6.47715 2 2 6.47715 2 12C2 17.5229 6.47715 22 12 22C17.5229 22 22 17.5229 22 12C22 6.47715 17.5229 2 12 2Z" stroke="#a855f7" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                            <path d="M14.3333 19V17.137C14.3583 16.8275 14.3154 16.5163 14.2073 16.2242C14.0993 15.9321 13.9286 15.6657 13.7067 15.4428C15.8 15.2156 18 14.4428 18 10.8885C17.9998 9.89772 17.6418 8.94773 17 8.22276C17.3039 7.33893 17.2824 6.36969 16.94 5.50033C16.94 5.50033 16.0933 5.2731 14.3333 6.42033C12.8691 6.02553 11.3309 6.02553 9.86667 6.42033C8.10667 5.2731 7.26 5.50033 7.26 5.50033C6.91757 6.36969 6.89607 7.33893 7.2 8.22276C6.55514 8.95077 6.19723 9.90676 6.2 10.8885C6.2 14.4351 8.4 15.2079 10.4933 15.4428C10.2733 15.6637 10.1037 15.9274 9.99502 16.2165C9.88632 16.5055 9.84211 16.8138 9.86667 17.1217V19" stroke="#a855f7" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                            <path d="M9.86667 17.1216C7.20001 18.0001 7.20001 15.4428 6 15.0001L9.86667 17.1216Z" stroke="#a855f7" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                          </svg>
                        </div>
                        <div>
                          <h4 className="font-bold text-white group-hover:text-purple-400 transition-colors">GitHub Repos</h4>
                          <p className="text-gray-400 text-sm">Open source tools and examples</p>
                        </div>
                      </div>
                    </Link>
                  </div>

...
export default function RubiksDocsPage() {
  ...
  const features = [
    {
      title: "AI-Powered Skin Generation",
      description: "Generate unique Rubik's Cube skins from text prompts, with customizable texture resolutions and animated reveal effects.",
      color: "purple" as const,
    },
    {
      title: "Interactive 3D Preview",
      description: "View and rotate a 3D Rubik's Cube with real-time texture updates, featuring a cyberpunk grid and no anti-aliasing for sharp visuals.",
      color: "pink" as const,
    },
    {
      title: "Preset Skin Prompts",
      description: "Kickstart creativity with presets like 'Neon cyberpunk cube' or 'Retro arcade puzzle,' auto-filling prompts for quick generation.",
      color: "blue" as const,
    },
    {
      title: "Custom Cursor",
      description: "A cube-themed animated cursor that scales and reacts to hover events, enhancing the futuristic user experience.",
      color: "purple" as const,
    },
    {
      title: "Download & Mint",
      description: "Export cube skins as high-resolution textures, with future support for minting as NFTs on the Solana blockchain.",
      color: "pink" as const,
    }
  ]
  ...
  return (
    <div ref={containerRef} className="relative bg-black text-white min-h-screen font-pixel">
      ...
      <div className="relative z-10 pt-24">
        <div className="flex">
          {/* Sidebar */}
          <DocsSidebar activeSection="rubiks" />
          ...
          <div className="flex-1 min-h-[calc(100vh-80px)]">
            ...
            <div className="border-b border-purple-900/30 px-6 py-12 lg:py-16 relative overflow-hidden">
              ...
              <div className="container mx-auto max-w-4xl relative z-10">
                ...
                >
                  <PixelHeading
                    text="VOID Rubik's Cube Creator"
                ...
                >
                  The VOID Rubik's Cube Creator is an AI-powered platform where users craft unique cube skins from text prompts, with interactive 3D previews, animated reveals, and future NFT minting.
                </motion.p>
              </div>
            </div>
            ...
            <div className="container mx-auto px-6 py-16">
              {/* VOID Rubik's Cube Creator Overview */}
              <div className="max-w-4xl mx-auto mb-12">
                <motion.div
                  ...
                  viewport={{ once: true }}
                >
                  <h2 className="text-2xl font-bold mb-4">VOID Rubik's Cube Creator - Overview</h2>
                </motion.div>
              </div>
              ...
              <div className="max-w-4xl mx-auto mb-12">
                ...
                >
                  ...
                  <p className="text-gray-300">
                    The VOID Rubik's Cube Creator combines nostalgic puzzle aesthetics with futuristic cyberpunk design, enabling users to generate custom Rubik's Cube skins from text prompts. With interactive 3D previews, animated texture reveals, and future NFT minting, it offers a dynamic creative experience enhanced by parallax effects and a responsive UI.
                  </p>
                </motion.div>
              </div>
              ...
              <div className="max-w-4xl mx-auto mb-16">
                ...
                >
                  ...
                  <p className="text-gray-300 mb-4">
                    Explore the core features that make the VOID Rubik's Cube Creator a unique tool for puzzle enthusiasts and artists.
                  </p>
                </motion.div>
              ...
              {/* AI-Powered Skin Generation section */}
              <div className="max-w-4xl mx-auto mb-12">
                <motion.div
                  initial={{ opacity: 0, y: 20 }}
                  whileInView={{ opacity: 1, y: 0 }}
                  ...
                  viewport={{ once: true }}
                >
                  <h2 className="text-2xl font-bold mb-4">AI-POWERED SKIN GENERATION</h2>
                  <p className="text-gray-300 mb-4">
                    Generate custom Rubik's Cube skins from descriptive text prompts, with high-resolution textures and animated reveals.
                  </p>
                  ...
                  <ul className="text-gray-300 space-y-2">
                    <li className="flex items-start">
                      ...
                      <span>Text prompt input for creative control (e.g., "neon cyberpunk cube")</span>
                    </li>
                    <li className="flex items-start">
                      <span className="h-2 w-2 bg-purple-500/20 mr-2 mt-2"></span>
                      <span>Texture resolutions: 64x64, 128x128, 256x256, 512x512 per cube face</span>
                    </li>
                    <li className="flex items-start">
                      <span className="h-2 w-2 bg-purple-500/20 mr-2 mt-2"></span>
                      <span>Animated texture reveal for engaging generation</span>
                    </li>
                    <li className="flex items-start">
                      <span className="h-2 w-2 bg-purple-500/20 mr-2 mt-2"></span>
                      <span>High-resolution texture output for cube faces</span>
                    </li>
                  </ul>
                </motion.div>
              </div>
              ...
              <div className="max-w-4xl mx-auto mb-12">
                <motion.div
                  ...
                  viewport={{ once: true }}
                >
                  <h2 className="text-2xl font-bold mb-4">INTERACTIVE 3D PREVIEW</h2>
                  <p className="text-gray-300 mb-4">
                    A responsive 3D preview system for viewing and customizing Rubik's Cube skins.
                  </p>
                  <h3 className="text-xl font-bold mb-2 text-pink-400">Key Features:</h3>
                  <ul className="text-gray-300 space-y-2">
                    <li className="flex items-start">
                      <span className="h-2 w-2 bg-pink-500/20 mr-2 mt-2"></span>
                      <span>Real-time rotation and interaction with 3D cube model</span>
                    </li>
                    <li className="flex items-start">
                      <span className="h-2 w-2 bg-pink-500/20 mr-2 mt-2"></span>
                      <span>Subtle cyberpunk grid for visual context</span>
                    </li>
                    <li className="flex items-start">
                      <span className="h-2 w-2 bg-pink-500/20 mr-2 mt-2"></span>
                      <span>No anti-aliasing for sharp, pixel-perfect textures</span>
                    </li>
                    <li className="flex items-start">
                      <span className="h-2 w-2 bg-pink-500/20 mr-2 mt-2"></span>
                      <span>Custom error messages displayed in preview</span>
                    </li>
                  </ul>
                </motion.div>
              </div>

              {/* Preset Skin Prompts section */}
              <div className="max-w-4xl mx-auto mb-12">
                <motion.div
                  initial={{ opacity: 0, y: 20 }}
                  whileInView={{ opacity: 1, y: 0 }}
                  ...
                  viewport={{ once: true }}
                >
                  <h2 className="text-2xl font-bold mb-4">PRESET SKIN PROMPTS</h2>
                  <p className="text-gray-300 mb-4">
                    Quick-start prompts to inspire cube skin designs and streamline creation.
                  </p>
                  <h3 className="text-xl font-bold mb-2 text-blue-400">Examples:</h3>
                  <ul className="text-gray-300 space-y-2">
                    <li className="flex items-start">
                      <span className="h-2 w-2 bg-blue-500/20 mr-2 mt-2"></span>
                      <span>Neon cyberpunk cube with glowing patterns</span>
                    </li>
                    <li className="flex items-start">
                      <span className="h-2 w-2 bg-blue-500/20 mr-2 mt-2"></span>
                      <span>Retro arcade puzzle with pixelated icons</span>
                    </li>
                    <li className="flex items-start">
                      <span className="h-2 w-2 bg-blue-500/20 mr-2 mt-2"></span>
                      <span>Cosmic galaxy cube with starry textures</span>
                    </li>
                    <li className="flex items-start">
                      <span className="h-2 w-2 bg-blue-500/20 mr-2 mt-2"></span>
                      <span>8-bit dungeon crawler theme</span>
                    </li>
                    <li className="flex items-start">
                      <span className="h-2 w-2 bg-blue-500/20 mr-2 mt-2"></span>
                      <span>Futuristic hologram cube with dynamic lights</span>
                    </li>
                  </ul>
                </motion.div>
              </div>
              ...
              <div className="max-w-4xl mx-auto mb-12">
                ...
                >
                  ...
                  <p className="text-gray-300 mb-4">
                    A cube-themed cursor enhances the futuristic experience.
                  </p>
                  <ul className="text-gray-300 space-y-2">
                    <li className="flex items-start">
                      <span className="h-2 w-2 bg-purple-500/20 mr-2 mt-2"></span>
                      <span>Animated cursor with 3D cube design</span>
                    </li>
                    <li className="flex items-start">
                      <span className="h-2 w-2 bg-purple-500/20 mr-2 mt-2"></span>
              ...
              <div className="max-w-4xl mx-auto mb-12">
                ...
                >
                  ...
                  <p className="text-gray-300 mb-4">
                    Save your cube skins or prepare them for blockchain minting.
                  </p>
                  <ul className="text-gray-300 space-y-2">
                    <li className="flex items-start">
                      <span className="h-2 w-2 bg-pink-500/20 mr-2 mt-2"></span>
                      <span>Download as high-resolution texture maps for cube faces</span>
                    </li>
                    <li className="flex items-start">
                      <span className="h-2 w-2 bg-pink-500/20 mr-2 mt-2"></span>
                    ...
                    <li className="flex items-start">
                      <span className="h-2 w-2 bg-pink-500/20 mr-2 mt-2"></span>
                      <span>Suitable for digital collectibles or 3D printing</span>
                    </li>
                  </ul>
                </motion.div>
              </div>
              ...
              <div className="max-w-4xl mx-auto mb-12">
                ...
                >
                  ...
                  <ul className="text-gray-300 space-y-2">
                    ...
                    <li className="flex items-start">
                      <span className="h-2 w-2 bg-blue-500/20 mr-2 mt-2"></span>
                      <span>Progressive texture reveal animation for skin generation</span>
                    </li>
                    <li className="flex items-start">
                      <span className="h-2 w-2 bg-blue-500/20 mr-2 mt-2"></span>
              ...
              <div className="max-w-4xl mx-auto mb-12">
                ...
                >
                  ...
                  <ul className="text-gray-300 space-y-2">
                    ...
                    <li className="flex items-start">
                      <span className="h-2 w-2 bg-purple-500/20 mr-2 mt-2"></span>
                      <span>WebGL (Three.js) for 3D cube rendering and interaction</span>
                    </li>
                    <li className="flex items-start">
                      <span className="h-2 w-2 bg-purple-500/20 mr-2 mt-2"></span>
                      <span>Custom API route (/api/generate-cube-skin) for AI processing</span>
                    </li>
                  </ul>
                </motion.div>
              </div>
              ...
              <div className="max-w-4xl mx-auto mb-12">
                ...
                >
                  ...
                  <p className="text-gray-300 mb-4">
                    Planned enhancements to expand the Rubik's Cube Creator's capabilities.
                  </p>
                  <ul className="text-gray-300 space-y-2">
                    <li className="flex items-start">
                      <span className="h-2 w-2 bg-pink-500/20 mr-2 mt-2"></span>
                    ...
                    <li className="flex items-start">
                      <span className="h-2 w-2 bg-pink-500/20 mr-2 mt-2"></span>
                      <span>Support for animated cube skin textures</span>
                    </li>
                    <li className="flex items-start">
                      <span className="h-2 w-2 bg-pink-500/20 mr-2 mt-2"></span>
                    ...
                    <li className="flex items-start">
                      <span className="h-2 w-2 bg-pink-500/20 mr-2 mt-2"></span>
                      <span>Social sharing and collaborative skin design mode</span>
                    </li>
                    <li className="flex items-start">
                      <span className="h-2 w-2 bg-pink-500/20 mr-2 mt-2"></span>
                      <span>Procedural puzzle pattern generator</span>
                    </li>
                  </ul>
                </motion.div>
              </div>
              ...
              <div className="max-w-4xl mx-auto mb-12">
                ...
                >
                  ...
                  <ul className="text-gray-300 space-y-2">
                    ...
                    <li className="flex items-start">
                      <span className="h-2 w-2 bg-blue-500/20 mr-2 mt-2"></span>
                      <span>Retro-futuristic puzzle aesthetics meets sci-fi minimalism</span>
                    </li>
                  </ul>
                </motion.div>
              </div>
              ...
              >
                ...
                <p className="text-gray-300 mb-6">
                  The VOID Rubik's Cube Creator is a portal to creative puzzle design, combining AI-powered skin generation with interactive 3D previews and future blockchain integration.
                </p>
                <p className="text-gray-300">
                  Craft your cube face by face. Welcome to the future of puzzles in VOID.
                </p>
                <div className="mt-8">
                  <Link href="/ai">
                    <Button
